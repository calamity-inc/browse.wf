...
<body data-bs-theme="dark">
	...
	<script>
		...
		Promise.all([
			...
			fetch("https://cdn.jsdelivr.net/gh/calamity-inc/warframe-public-export-plus@0.5.x/ExportArcanes.json").then(res => res.json()),
			fetch("https://cdn.jsdelivr.net/gh/calamity-inc/warframe-public-export-plus@0.5.x/ExportResources.json").then(res => res.json()),
			...
			fetch("https://cdn.jsdelivr.net/gh/calamity-inc/warframe-public-export-plus@0.5.x/ExportGear.json").then(res => res.json()),
			...
			fetch("https://cdn.jsdelivr.net/gh/calamity-inc/warframe-public-export-plus@0.5.x/ExportAbilities.json").then(res => res.json()),
